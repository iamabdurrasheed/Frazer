      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-6 lg:gap-8">
          {brands.map((brand, index) => (
            <Link href={brand.link} key={brand.id} className="h-full">
              <div className="group relative bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-2xl p-6 hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:border-blue-300/50 h-full flex flex-col">
                ...
                <div className="relative flex-1 flex flex-col">
                  {/* Brand Logo */}
                  <div className="w-full h-32 mb-6 relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 flex-shrink-0">
                    <img
                      src={brand.logo}
                  ...
                  <div className="text-center flex-1 flex flex-col">
                    ...
                    <div className="inline-flex items-center justify-center text-blue-600 font-semibold text-sm group-hover:text-blue-700 transition-colors duration-300 mt-auto">
                      View Products
