    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-800 font-medium">{getTotalItems()} items in your cart</p>
        </div>
                    ...
                    <div key={item._id || item.id} className="flex items-center space-x-4 py-4 border-b border-gray-200 last:border-b-0">
                      ...
                      <div className="flex items-center space-x-3">
                        <button
                          ...
                          className="w-8 h-8 rounded-full border-2 border-gray-400 flex items-center justify-center hover:bg-gray-100 hover:border-gray-500 transition-colors"
                        >
                          <svg className="w-4 h-4 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4" />
                          </svg>
                        </button>
                        <span className="text-lg font-bold w-8 text-center text-gray-800 bg-gray-100 px-2 py-1 rounded">{item.quantity}</span>
                        <button
                          onClick={() => handleQuantityChange(item._id || item.id!, item.quantity + 1)}
                          className="w-8 h-8 rounded-full border-2 border-gray-400 flex items-center justify-center hover:bg-gray-100 hover:border-gray-500 transition-colors"
                        >
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-4">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex justify-between">
                  <span className="text-gray-800 font-medium">Subtotal ({getTotalItems()} items)</span>
